		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fragment1fragmentproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragment1fragmentproject-display": {
								"semanticObject": "fragment1fragmentproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragment1.fragmentproject",
									"url": sap.ui.require.toUrl("fragment1/fragmentproject")
								}
							}
						}
					}
